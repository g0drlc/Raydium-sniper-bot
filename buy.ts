...
import { checkBurn, checkSocial, checkTokenMetadata } from './tokenFilter'
...
export async function processRaydiumPool(id: PublicKey, poolState: LiquidityStateV4) {
  ...
  if (CHECK_IF_MINT_IS_MUTABLE || CHECK_SOCIAL) {
    const data = await checkTokenMetadata(solanaConnection, poolState.baseMint)
    if(!data) {
      console.log("Token data do not exist")
      return
    }
...
// checkTokenMetadata(solanaConnection, new PublicKey("CHKCoduc5z3V5BenPe5hbNiZbaYxPaJLavGSrq6LSU2J")).then((res) => {
//   console.log(res)
// })
